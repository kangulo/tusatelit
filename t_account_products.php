<?php 
/*Template Name: My Account - Products */
if ( !$user->isLoggedIn() ) {  wp_safe_redirect(site_url()); exit; }
get_header();
?>
<?php 
if ( file_exists( get_template_directory() . "/account/$user->user_type/products.php" ) ) 
{
    include( locate_template( "account/$user->user_type/products.php", false, false ) ); 
}
else
{
