<?php 
/*Template Name: My Account - Store*/
if ( !$user->isLoggedIn() ) {  wp_safe_redirect(site_url()); exit; }
get_header();
?>
<?php 
if ( file_exists( get_template_directory() . "/account/$user->user_type/store.php" ) ) 
{
    include( locate_template( "account/$user->user_type/store.php", false, false ) ); 
}
else
{
